    ...
    <Modal
      ...
      <View
        ...
        <View className="w-full max-w-[360px] rounded-2xl bg-white p-6">
          ...
          {info?.latestVersion ? (
            <Text className="mb-3 font-pmedium text-gray-700">
          ...
          {isMandatory ? (
            <>
              <Text className="mb-4 font-pregular text-red-600">
            ...
            <View className="mt-2 flex-row gap-x-3">
              ...
              <View className="flex-1">
                <CustomButton text="Update now" handlePress={onUpdateNow} containerStyles="py-3" />
              </View>
            </View>
          )}
        </View>
