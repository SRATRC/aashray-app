...
// Resolves the API base URL from the dev-backend toggle. Used by the shared
// apiClient (lib/api/client.ts), useTicketStream.ts, and collectDiagnostics.ts
// — new call sites needing this logic should use this instead of re-deriving it
