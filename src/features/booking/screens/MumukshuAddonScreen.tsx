...
import { validateMumukshuBooking } from '../api';
import MumukshuAdhyayanAddon from '../components/MumukshuAdhyayanAddon';
import MumukshuAdhyayanBookingDetails from '../components/MumukshuAdhyayanBookingDetails';
import MumukshuEventBookingDetails from '../components/MumukshuEventBookingDetails';
import MumukshuFlatBookingDetails from '../components/MumukshuFlatBookingDetails';
import MumukshuFoodAddon from '../components/MumukshuFoodAddon';
import MumukshuRoomAddon from '../components/MumukshuRoomAddon';
import MumukshuRoomBookingDetails from '../components/MumukshuRoomBookingDetails';
import MumukshuTravelAddon from '../components/MumukshuTravelAddon';
import MumukshuTravelBookingDetails from '../components/MumukshuTravelBookingDetails';
