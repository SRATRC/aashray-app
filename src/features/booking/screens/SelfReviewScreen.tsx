...
import AdhyayanBookingDetails from '../components/AdhyayanBookingDetails';
import EventBookingDetails from '../components/EventBookingDetails';
import FoodBookingDetails from '../components/FoodBookingDetails';
import RoomBookingDetails from '../components/RoomBookingDetails';
import TravelBookingDetails from '../components/TravelBookingDetails';
...
const BookingReview = () => {
  ...
  const fetchValidation = useCallback(async () => {
    try {
      const res = await validateMumukshuBooking(payload);
          ...
          <View className="mb-8 flex-row gap-x-4">
            <CustomButton
              ...
              handlePress={async () => {
                ...
                try {
                  const data = await submitMumukshuBooking(payload);
                  onSuccess(data);
                } catch {
                  // apiClient already surfaces the error toast/haptic
                } finally {
