...
import { validateGuestBooking } from '../api';
import GuestAdhyayanAddon from '../components/GuestAdhyayanAddon';
...
import GuestFoodAddon from '../components/GuestFoodAddon';
import GuestRoomAddon from '../components/GuestRoomAddon';
