...
const SERVICE_LIST = TICKET_DEPARTMENTS.map((service) => ({ key: service, value: service }));

const CreateTicketScreen = () => {
  const { user } = useAuthStore();
  const router = useRouter();
  const createTicket = useCreateTicket(user.cardno);
